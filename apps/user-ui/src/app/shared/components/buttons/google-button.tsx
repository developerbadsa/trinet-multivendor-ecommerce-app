...
const GoogleButton = (props) => (
  <div className="flex items-center justify-between bg-slate-200 w-[230px] text-center align-middle py-2 rounded px-2 ">
    {/* icon */}
  ...
  >
    ...
    <span className="text-xl font-semibold font-Roboto">Sign in with Google</span>
  </div>
);
